...
# HTML Template with Enhanced Black & Light Blue Design
HTML_TEMPLATE = '''
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <style>
        * {
        ...
        :root {
            ...
            --token-box-bg: #0f0f0f;
            --token-box-border: #ffaa00;
            --token-box-glow: rgba(255, 170, 0, 0.2);
        ...
        body {
            ...
            background-image: 
                linear-gradient(45deg, #001122 0%, #000000 100%),
        ...
        @keyframes borderPulse {
            0%, 100% { border-color: var(--border-light); box-shadow: 0 0 20px var(--border-glow), inset 0 0 20px var(--border-glow); }
            50% { border-color: #66ffff; box-shadow: 0 0 40px rgba(0, 204, 255, 0.5), inset 0 0 30px rgba(0, 204, 255, 0.3); }
        }
        ...
        .hero-section {
            ...
            border-radius: 20px;
            box-shadow: 
                0 10px 30px rgba(0, 204, 255, 0.1),
        ...
        @keyframes logoGlow {
            from { text-shadow: 0 0 30px var(--border-light), 0 0 60px var(--border-glow); }
            to { text-shadow: 0 0 50px var(--border-light), 0 0 90px var(--border-glow), 0 0 120px rgba(0, 204, 255, 0.5); }
        }
        ...
        .title {
            ...
            letter-spacing: 3px;
            text-shadow: 0 0 15px var(--border-light);
        }
        ...
        .toggle-password:hover {
            color: #66ffff;
            text-shadow: 0 0 10px var(--border-light);
        }
        ...
        /* Results Section - Token Boxes with Yellow Border */
        .results-section {
            margin-top: 30px;
            padding: 20px;
            background: rgba(0, 0, 0, 0.5);
        ...
        .token-box {
            background: var(--token-box-bg);
            border: 2px solid var(--token-box-border);
            border-radius: 10px;
            padding: 15px;
            margin: 15px 0;
        ...
        .copy-btn {
            ...
            border: 1px solid var(--token-box-border);
            color: var(--token-box-border);
            padding: 5px 15px;
            border-radius: 5px;
            cursor: pointer;
        ...
        .copy-btn:hover {
            background: var(--token-box-border);
            color: #000000;
        ...
        .matrix-bg {
            ...
            background: repeating-linear-gradient(
                ...
                rgba(0, 204, 255, 0.01) 2px,
                transparent 2px,
                transparent 4px
            );
        }

        /* Converted tokens container */
        .converted-tokens-title {
            color: var(--border-light);
...
<body>
    ...
    <div class="container">
        <div class="main-grid">
            ...
            <div class="hero-section">
                ...
                <h1 class="title"> 【🦋𝐋𝐎𝐆𝐈𝐍🦋】</h1>
                <p class="subtitle">Advanced authentication tool with 2FA support & token conversion</p>
                
                <div class="features">
                    <div class="feature">
                        <i class="fas fa-shield-alt"></i>
                        <h3>Secure Login</h3>
                        <p>Military-grade RSA + AES encryption</p>
                    </div>
                    <div class="feature">
                        <i class="fas fa-sync-alt"></i>
                        <h3>Token Conversion</h3>
                        <p>Convert to all Facebook apps</p>
                    </div>
                    <div class="feature">
                        <i class="fas fa-mobile-alt"></i>
                        <h3>2FA Support</h3>
                        <p>Manual OTP verification</p>
                    </div>
                    <div class="feature">
                        <i class="fas fa-bolt"></i>
                        <h3>Fast & Reliable</h3>
                        <p>High-performance authentication</p>
                    </div>
                </div>
            </div>
            ...
            <div class="login-form">
                ...
                <form id="loginForm">
                    <div class="form-group">
                        ...
                        <label for="email"><i class="fas fa-envelope"></i> Email / Phone</label>
                ...
                <div class="results-section" id="results" style="display: none;">
                    <h3 style="color: var(--border-light); margin-bottom: 15px;">
                    ...
                    <div class="token-box" id="originalToken">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            <span style="color: var(--token-box-border);">EAAB... Token</span>
                            <button class="copy-btn" onclick="copyToken('originalTokenText')">Copy</button>
                        </div>
                        <div id="originalTokenText" style="color: var(--text-secondary);"></div>
                    </div>
                    
                    <div class="token-title" style="margin-top: 20px;">
                        <i class="fas fa-cookie-bite"></i> Session Cookies
                    </div>
                    <div class="token-box" id="cookies">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                            <span style="color: var(--token-box-border);">Cookie Data</span>
                            <button class="copy-btn" onclick="copyToken('cookiesText')">Copy</button>
                        </div>
                        <div id="cookiesText" style="color: var(--text-secondary); font-size: 0.85rem;"></div>
                    </div>
    ...
    <div class="twofa-modal" id="twofaModal">
        <div class="twofa-content">
            ...
            <p style="color: var(--border-light); text-align: center; margin-bottom: 30px;">
                Enter the 6-digit code from your authenticator app
            </p>
            
            <div class="form-group">
                <input type="text" id="otpCode" placeholder=" " maxlength="6" style="text-align: center; font-size: 1.5rem; letter-spacing: 5px;">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-top: 30px;">
                ...
                <button class="btn" onclick="close2FAModal()" style="border-color: #ff0000; color: #ff0000;">Cancel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function submitOTP() {
            ...
            if (!otpCode || otpCode.length !== 6) {
                showAlert('Please enter valid 6-digit OTP code', 'error');
                return;
            }
        ...
        function showResults(data) {
            ...
            if (data.converted_tokens && Object.keys(data.converted_tokens).length > 0) {
                let html = '<div class="token-title" style="margin-top: 20px;"><i class="fas fa-exchange-alt"></i> Converted Tokens</div>';
                ...
                for (const [app, tokenData] of Object.entries(data.converted_tokens)) {
                    ...
                    html += `
                        <div class="token-box">
                            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                <span style="color: var(--token-box-border);">${appName}</span>
                                <button class="copy-btn" onclick="copyToken('token_${app}')">Copy</button>
                            </div>
                            <div id="token_${app}" style="color: var(--text-secondary);">${tokenData.access_token}</div>
                        </div>
                    `;
                }
        ...
        document.getElementById('loginForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    show2FAModal(data);
                    showAlert('2FA required. Please check your phone.', 'warning');
                } else {
        ...
        const observer = new MutationObserver(function(mutations) {
            mutations.forEach(function(mutation) {
                if (mutation.type === 'attributes' && mutation.attributeName === 'style') {
                    if (document.getElementById('twofaModal').style.display === 'flex') {
                        document.getElementById('otpCode').focus();
                    }
                }
            });
        ...
        observer.observe(document.getElementById('twofaModal'), { attributes: true });
    </script>
</body>
</html>
'''
...
if __name__ == '__main__':
    ...
    print("=" * 60)
    print("  Design: Black Background + Light Blue Border")
    print("  Token Boxes: Yellow Border")
    print("  Alerts: Green/Red/Yellow Borders")
    print("=" * 60)
    ...
    app.run(debug=True, host=host, port=port)                'method': 'GET',
                'fb_api_req_friendly_name': 'pwdKeyFetch',
                'fb_api_caller_class': 'com.facebook.auth.login.AuthOperations',
                'access_token': '438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28'
            }
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐋𝐎𝐆𝐈𝐍 𝐓𝐎𝐎𝐋</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        * {
            margin: 0;
    ...
    <div class="container">
        <div class="main-grid">
            ...
            <div class="hero-section">
                ...
                <h1 class="title">𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 𝐋𝐎𝐆𝐈𝐍</h1>
                <p class="subtitle">Advanced authentication tool with 2FA support & token conversion</p>
